...
class ApiClient {
  ...
  Future<ApiResponse<Response>> postData({
    required String url,
  ...
  Future<ApiResponse<Response>> getData({
    required String url,
    Map<String, dynamic>? queryParameters,
    Map<String, dynamic>? headers,
  }) async {
  ...
  Future<ApiResponse<Response>> deleteData({
    required String url,
    Map<String, dynamic>? queryParameters,
    Map<String, dynamic>? headers,
  }) async {
...
/*
  ...
  try {
    ApiResponse<Response> postResponse = await apiClient.postData(
